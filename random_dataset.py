...
for i in range(num_datapoints):
    ...
    with open("/home/lshi23/carla_test/data/datapoints/%06d.json" % i, "w") as outfile:outfile.write(json_object)
    
    if i/num_datapoints*100 % 10 == 0:
        print('Datapoint creation process: ', i/num_datapoints*100, '%')
